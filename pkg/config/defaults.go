...
const (
	...
	// exposes a Gateway, see https://github.com/negativefeast/stunner-gateway-operator/issues/47.
	...
	// https://github.com/negativefeast/stunner-gateway-operator/issues/49.
